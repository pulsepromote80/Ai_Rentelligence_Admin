              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <span
                      className={`inline-flex px-3 py-1 mt-1 text-xs font-semibold rounded-full ${
                        selectedBooking.TicketType?.toLowerCase() === 'vip'
                          ...
                          : selectedBooking.TicketType?.toLowerCase() ===
                              'premium'
                  ...
                  <div>
                    ...
                    <p className="mt-1 font-medium text-gray-900">
                      {selectedBooking.PlanPrice
                        ? `₹${typeof selectedBooking.PlanPrice === 'number' ? selectedBooking.PlanPrice.toLocaleString() : selectedBooking.PlanPrice}`
                        : '—'}
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="mt-1 text-lg font-semibold text-gray-900">
                      {selectedBooking.Price
                        ? `₹${typeof selectedBooking.Price === 'number' ? selectedBooking.Price.toLocaleString() : selectedBooking.Price}`
                        : '—'}
                    </p>
                  </div>
                </div>
          ...
          <div className="p-8 text-center border border-gray-200 rounded-lg bg-gray-50">
            ...
            <p className="mt-1 text-xs text-gray-400">
              {searchTerm
                ...
                : 'There are no event bookings to display'}
            </p>
            {searchTerm && (
              <button

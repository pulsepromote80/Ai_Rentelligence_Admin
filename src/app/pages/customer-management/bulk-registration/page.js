    ...
    <div className="flex items-center justify-center p-0 mx-auto mt-0">
      <div className="w-full max-w-2xl p-10 bg-white rounded-3xl shadow-2xl border ">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full py-3 text-lg font-semibold text-white rounded-xl shadow-md transition-all bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 focus:ring-4 focus:ring-blue-300 disabled:opacity-50 disabled:cursor-not-allowed"
            disabled={userLoading || regLoading || countryLoading || !!errors.authLogin}
          >
            {(userLoading || regLoading || countryLoading) ? <div className="flex items-center justify-center gap-2">

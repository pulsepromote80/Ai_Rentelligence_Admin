...
<div className='flex items-center justify-center'>
  <div className='w-full max-w-2xl p-8 bg-white rounded-3xl shadow-xl border'>
    <h6 className="heading">Change Password</h6>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`bg-gray-100 focus:bg-white focus:ring-2 focus:ring-blue-400 focus:border-blue-400 block w-full pl-10 px-4 py-3 rounded-lg text-gray-900 placeholder-gray-400 outline-none transition ${errors.username ? 'border border-red-300' : 'border-none'}`}
            />
          </div>
          {errors.username && (
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`bg-gray-100 focus:bg-white focus:ring-2 focus:ring-blue-400 focus:border-blue-400 block w-full pl-10 pr-10 px-4 py-3 rounded-lg text-gray-900 placeholder-gray-400 outline-none transition ${errors.oldPassword ? 'border border-red-300' : 'border-none'}`}
            />
            <button
              type="button"
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className={`bg-gray-100 focus:bg-white focus:ring-2 focus:ring-blue-400 focus:border-blue-400 block w-full pl-10 pr-10 px-4 py-3 rounded-lg text-gray-900 placeholder-gray-400 outline-none transition ${errors.newPassword ? 'border border-red-300' : 'border-none'}`}
          />
          <button
            type="button"

...
import {
  fetchAllAdminUsersList,
  fetchActivateAdminUser,
  fetchDeActivateAdminUser,
} from '@/app/redux/adminUserSlice'
import { toast } from 'react-toastify'

const ManageAdmin = () => {
  const dispatch = useDispatch()
  const { allAdminListData, loading, error, activateStatus } = useSelector(
    (state) => state.admin,
  )

...
<div className="grid grid-cols-1 gap-6 mb-8 sm:grid-cols-2 md:grid-cols-5 lg:grid-cols-5">
            ...
            <div className="p-6 bg-white border-l-4 border-yellow-500 shadow rounded-xl">
              ...
              <div className="mt-1 text-sm text-gray-500 dashboard-card-sub-heading">Total Income Withdrawal</div>
            </div>

            <div className="p-6 bg-white border-l-4 border-yellow-500 shadow rounded-xl">
              <div className="text-3xl font-bold text-gray-900 dashboard-card-heading">${stats.TotalRentWithdrawal}</div>
              <div className="mt-1 text-sm text-gray-500 dashboard-card-sub-heading">Total Rent Withdrawal</div>
            </div>
